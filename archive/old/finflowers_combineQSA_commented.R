...
#setwd to own clone path folder: 
...
##### @ erza stefan to do / restore 
#code got lost and needs to be adjusted, 
#for now in EAtest it is loaded with all1. from U:\Topics\Spillovers_and_EA\flowoffunds\finflows2024\gitcodedata\data
