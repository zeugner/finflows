...
dimnames(lc)
dimnames(lct)
names(dimnames(lc))[[3]] = names(dimnames(lct))[[3]] = 'REF_AREA'
names(dimnames(lc))[[2]] = names(dimnames(lct))[[2]] = 'INSTR'
names(dimnames(lc))[[1]] = names(dimnames(lct))[[1]] = 'REF_SECTOR'
...
####EA18=EA19=EA20
lc_q["..EA18.", onlyna=TRUE]=lc_q["..EA19.", onlyna=TRUE]<-lc_q["..EA20.", onlyna=TRUE]<-lc_q["..EA21."]
lct_q["..EA18.", onlyna=TRUE]=lct_q["..EA19.", onlyna=TRUE]<-lct_q["..EA20.", onlyna=TRUE]<-lct_q["..EA21."]
...
### Stefano: I do not think this is necessary
##############################################################################
# 
...
temp = add.dim(flows_assets, .dimname = 'COUNTERPART_SECTOR', .dimcodes = c(sa_sectors), .fillall = FALSE)
