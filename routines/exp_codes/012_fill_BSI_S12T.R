...
names(dimnames(libsi))[[1]] = 'REF_AREA'
...
#ASSETS FILLING
aall[..S12T..LE._T., usenames=TRUE, onlyna=TRUE] = zerofiller(asbsi["...1998q4:"])
#check
aall[F5.AT.S12T..LE._T.2022q4]
...
#LIABILITIES FILLING
aall[F5..S0.S12T.LE._T., usenames=TRUE, onlyna=TRUE] = zerofiller(libsi[".1998q4:"])

##### FILL F51M NAS AS RESIDUAL BETWEEN THESE NEW F51 AND POSSIBLY PREEXISTING F511
gc()
aall[F51M..S12T..LE._T., usenames=TRUE, onlyna=TRUE] = zerofiller(aall["F51..S12T..LE._T."])-zerofiller(aall["F511..S12T..LE._T."])
