<<<<<<<< HEAD:routines/archive_codes/003_finflowers_EAtest.R
...
aall=readRDS('\\\\s-jrciprnacl01p-cifs-ipsc.jrc.it/ECOFIN/FinFlows/githubrepo/finflows/data/intermediate_domestic_data_files/aall_qsa.rds')
...
aall[.AT.S12+S12O+S124+S12Q.S0.LE._T.y2022q4]
...
saveRDS(aall, 'data/intermediate_domestic_data_files/aall_qsa_assumptions.rds')
========
...
# Load the previously created matrix
aall=readRDS(file.path(data_dir, 'intermediate_domestic_data_files/aall_qsa.rds'))
...
saveRDS(aall, file.path(data_dir, 'intermediate_domestic_data_files/aall_qsa_assumptions.rds'))
>>>>>>>> 55a5a789115f3c6e93936ceaded19180b9724739:routines/domestic/002_finflowers_EAtest.R
