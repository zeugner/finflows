...
absirawq=mds('ECB/BSI/Q..N.A.A41+A5A+A50.A.1...Z01.E',labels=TRUE, ccode = NULL) #separating Q and M because of widely different elements that are filled
absirawm=mds('ECB/BSI/M..N.A.A41+A5A+A50.A.1...Z01.E',labels=FALSE, ccode = NULL)
...
absi=copy(absiraw)
names(dimnames(absi))[2:4] =c('INSTRUMENT','COUNTERPART_AREA','COUNTERPART_SECTOR')
...
dimnames(absi)[[4]] = dictbsisec[dimnames(absi)[[4]]]
...
saveRDS(asbsi,file='bsi_ass.rds')
saveRDS(libsi,file='bsi_lia.rds')
