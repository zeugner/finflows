...
bbsirawqld=mds('ECB/BSI/Q..N.A.A20+L20..1+4...Z01.E',labels=TRUE, ccode = NULL) #separating Q and M because of widely different elements that are filled
bbsirawmld=mds('ECB/BSI/M..N.A.A20+L20..1+4...Z01.E',labels=FALSE, ccode = NULL)

gc()
gc()
bbsiraw=aggregate(bbsirawmld,'Q',FUN = end)
gc()
...
suppressWarnings(bbsiraw[usenames=TRUE] <- bbsirawqld)
...
bbsiraw[AT.A20.A.1...2023q4]
bbsi=copy(bbsiraw)

dimnames(bbsi)
bbsi[AT.A20.A.1...2023q4]
