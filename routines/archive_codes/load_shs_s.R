...
saveRDS(ashsraw,file='data/ashsraw.rds')
#ashsraw=readRDS("V:/FinFlows/githubrepo/trialarea/data/ashsraw.rds"); gc()
gc()
...
#ash=readRDS("V:/FinFlows/githubrepo/trialarea/data/ash.rds"); gc()
