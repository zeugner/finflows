...
# Load data
cpa= readRDS("data/cpa_new.rds")
cpq= readRDS("data/cpq_new.rds")
cpq_fdi= readRDS("data/cpq_fdi_new.rds")
aall= readRDS("data/intermediate_domestic_data_files/aall_shss.rds")
...
saveRDS(aall,'data/intermediate_domestic_data_files/aall_cp.rds')
