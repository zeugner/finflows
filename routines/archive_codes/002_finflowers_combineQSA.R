<<<<<<<< HEAD:routines/archive_codes/002_finflowers_combineQSA.R
...
### stetting order to sectors and calculating RoW (S2) + financial sector excluding S12K
# saving as aall1
dimnames(aall)[[3]]
dim(aall)
...
# Save 
saveRDS(aall, 'data/intermediate_domestic_data_files/aall_qsa.rds')
========
...
>>>>>>>> 55a5a789115f3c6e93936ceaded19180b9724739:routines/domestic/001_finflowers_combineQSA.R
