...
aall <- readRDS("data/intermediate_domestic_data_files/aall_f51m.rds")

tradecredits_al=mds('ECB/QSA/Q.N..W0+W1...N.A+L.LE.F81.T._Z.XDC._T.S.V.N._T')
saveRDS(tradecredits_al,'data/tradecredits_al.rds')
...
saveRDS(bopf81q,'data/bopf81q.rds')
bopf81a=copy(bopf81_a); frequency(bopf81a)='Q'
saveRDS(bopf81a,'data/bopf81a.rds')


#names(dimnames(tradecredits_al)) =gsub("^INSTR.*$","INSTR",names(dimnames(tradecredits_al)))
...
saveRDS(tradecredits,'data/tradecredits.rds')
gc()
gc()
...
aall[F81..S1+S11+S13+S1M+S12O.S1.LE._S.2022q4]
...
aall["F81.AT...LE._S.2022q4"]
saveRDS(aall,'data/aall_f81.rds')
