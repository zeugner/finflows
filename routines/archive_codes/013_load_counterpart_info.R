...
saveRDS(cpq,file='data/cpq_new.rds')
...
### crea cpq_fdi raw 
saveRDS(cpq_fdi,file='data/cpq_fdi_new.rds')
...
## note for domestic linkages, A and L are the same accross QSA and NASA_10_F_CP
# cpinfo[S1.S11.ASS..2022]
# qsinfo[.W2.S11.A.2022q4]

## but nor for links with external (S2):
...
saveRDS(cpa,file='data/cpa_new.rds')
