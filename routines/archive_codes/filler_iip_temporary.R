...
saveRDS(aa,file='aa_iip_cps_temp.rds')
saveRDS(ll,file='ll_iip_cps_temp.rds')
...
saveRDS(aa,file='aa_bop_cps_eu_temp.rds')
...
saveRDS(ll,file='ll_bop_cps_eu_temp.rds')
...
saveRDS(aa,file='aa_bop_cps_temp.rds')
#aa=readRDS(file.path(data_dir,'aa_bop_cps_temp.rds')); gc()
...
saveRDS(ll,file='ll_bop_cps_temp.rds')
...
gc()
saveRDS(aa,file='aa_iip_cps.rds')

saveRDS(ll,file='ll_iip_cps.rds')


saveRDS(aa,file='vintages/aa_iip_cps_' %&% format(Sys.time(),'%F') %&% '_.rds')
saveRDS(ll,file='vintages/ll_iip_cps_' %&% format(Sys.time(),'%F') %&% '_.rds')
# 
