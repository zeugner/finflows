...
##############################################################
##############################################################
###temporary solution!! Erza to delete 
##############################################################
##############################################################
...
aall[..S12R.S2.LE._D., usenames=FALSE, onlyna=TRUE] = fnd[..S124.S0.LE.]+fnd[..S12O.S0.LE.]+fnd[..S12Q.S0.LE.]
aall[...S2.F._D., usenames=FALSE, onlyna=TRUE] = fnd[...S0.F.]
aall[..S12R.S2.F._D., usenames=FALSE, onlyna=TRUE] = fnd[..S124.S0.F.]+fnd[..S12O.S0.F.]+fnd[..S12Q.S0.F.]
###direct investment liabilities from ECB QSA
aall[..S2..LE._D., usenames=FALSE, onlyna=TRUE] = fnd[..S0..LE.]
aall[..S2.S12R.LE._D., usenames=FALSE, onlyna=TRUE] = fnd[..S0.S124.LE.]+fnd[..S0.S12O.LE.]+fnd[..S0.S12Q.LE.]
aall[..S2..F._D., usenames=FALSE, onlyna=TRUE] = fnd[..S0..F.]
aall[..S2.S12R.F._D., usenames=FALSE, onlyna=TRUE] = fnd[..S0.S124.F.]+fnd[..S0.S12O.F.]+fnd[..S0.S12Q.F.]
...
gc()
saveRDS(aa,file='data/aa_iip_cps.rds')

saveRDS(ll,file='data/ll_iip_cps.rds')
# 
