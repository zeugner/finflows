#aall <- readRDS("Z:/FinFlows/githubrepo/finflows/data/intermediate domestic data files/aall13.rds")
defaultcountrycode(NULL)
library(MD3)
library(MDstats)
otheq_al=mds('ECB/QSA/Q.N..W0+W1+W2...N.A+L.LE.F512+F519._Z._Z.XDC..S.V.N._T')
#saveRDS(otheq,file='data/otheq.rds')
# otheq=readRDS('data/otheq.rds')
#names(dimnames(otheq))[2] ='COUNTERPART_SECTOR' 
otheq_al <- readRDS("data/otheq_al.rds")
...
#dimnames(aall)
#dimnames(otheq)
#otheq=add.dim(otheq,.dimname = 'FUNCTIONAL_CAT',.dimcodes = '_T')
otheq=add.dim(otheq,.dimname = 'CUST_BREAKDOWN',.dimcodes = '_T')
dimnames(otheq)[[1]]='_T'

xrates <- readRDS("Z:/FinFlows/githubrepo/finflows/data/xrates_final.rds")

otherequity = otheq*xrates[LE..]
#dimnames(otherequity)
...
#af51=aperm(af51,c("FUNCTIONAL_CAT","REF_AREA","COUNTERPART_SECTOR","REF_SECTOR","INSTR_ASSET","TIME"))
...
#what follows is sometimes a necessary step to load the data...
#helpmds("ESTAT/bop_iip6_q/Q.MIO_EUR.FA__D__F519+FA__O__F519+FA__D__F512+FA__P__F512+FA__D__F51M..S1.A_LE+L_LE.WRL_REST.")
#bopf51mq=mds('Estat/bop_iip6_q/Q.MIO_EUR.FA__D__F519+FA__O__F519+FA__D__F512+FA__P__F512+FA__D__F51M..S1.A_LE+L_LE.WRL_REST.')
saveRDS(bopf51mq,'data/bopf51mq.rds')
...
saveRDS(bopf51ma,'data/bopf51ma.rds')

# bopf51mq[.S121..., onlyna=TRUE] = 0
# bopf51ma[.S121..., onlyna=TRUE] = 0

af51[FND..S2..F51M.]<-af51[FND..S0..F51M.]

names(dimnames(bopf51ma))[1]=names(dimnames(bopf51mq))[1]='REF_AREA'  #########################FOR STEFANO
names(dimnames(bopf51mq))[2]='REF_SECTOR'
names(dimnames(bopf51ma))[2]='REF_SECTOR'

af51['_F+_O+_P+_R.....'] <- NA
af51[.AT.S2.S1.F519.1999q1]
####QUARTERLY
...
##### FOR STEFANO: ERZA CODE IN THE CHAT TO DEAL WITH THE TEMPORARY SUMS !!!!! ###########


#af51["_T..S2..F512.",onlyna=TRUE]<-bopf51mq["..A_LE.FA__P__F512.1998q4:"]+bopf51mq["..A_LE.FA__D__F512.1998q4:"]

#af51["_T..S2..F519.",onlyna=TRUE]<-bopf51mq["..A_LE.FA__O__F519.1998q4:"]+bopf51mq["..A_LE.FA__D__F519.1998q4:"]

#af51["_T..S2..F51M.", onlyna=TRUE]<-af51["_T..S2..F512."]+af51["_T..S2..F519."]
...
#af51["_T...S2.F512.",onlyna=TRUE]<-bopf51mq_liab["..L_LE.FA__P__F512.1998q4:"]+bopf51mq_liab["..L_LE.FA__D__F512.1998q4:"]
#af51["_T...S2.F519.",onlyna=TRUE]<-bopf51mq_liab["..L_LE.FA__O__F519.1998q4:"]+bopf51mq_liab["..L_LE.FA__D__F519.1998q4:"]
#af51["_T...S2.F51M.", onlyna=TRUE]<-af51["_T...S2.F512."]+af51["_T...S2.F519."]
...
# af51["_T..S2..F512.",onlyna=TRUE]<-bopf51ma["..A_LE.FA__P__F512.1998q4:"]+bopf51ma["..A_LE.FA__D__F512.1998q4:"]
# af51["_T..S2..F519.",onlyna=TRUE]<-bopf51ma["..A_LE.FA__O__F519.1998q4:"]+bopf51ma["..A_LE.FA__D__F519.1998q4:"]
# 
# af51["_T..S2..F51M.",onlyna=TRUE]<-af51["_T..S2..F512."]+af51["_T..S2..F519."]
...
# af51["_T...S2.F512.",onlyna=TRUE]<-bopf51ma_liab["..L_LE.FA__P__F512.1998q4:"]+bopf51ma_liab["..L_LE.FA__D__F512.1998q4:"]
# af51["_T...S2.F519.",onlyna=TRUE]<-bopf51ma_liab["..L_LE.FA__O__F519.1998q4:"]+bopf51ma_liab["..L_LE.FA__D__F519.1998q4:"]
# 
# af51["_T...S2.F51M.",onlyna=TRUE]<-af51["_T...S2.F512."]+af51["_T...S2.F519."]
saveRDS(af51,'data/af51m_INT.rds')
### ATTENTION here some S2 are bigger than S0... so we impose the max between the difference and 0 ##########################       CHECK WITH ERZA AND STEFAN
...
saveRDS(af51,'data/af51_intermediate.rds')
...
af51=unflag(af51)
af51_S=as.data.table(af51,.simple=TRUE); gc()
af51cast=dcast(af51_S, ... ~ CUST_BREAKDOWN, id.vars=1:7, value.var = 'obs_value'); gc()
...
af51cast2=copy(af51cast[,intersect(c(colnames(af51_S),'_S'),colnames(af51cast)),with=FALSE]);gc()
colnames(af51cast2)[NCOL(af51cast2)]='obs_value';gc()
af51cast2[,CUST_BREAKDOWN:='_S'];gc()
af51_S=rbind(af51_S,af51cast2,fill=TRUE);gc()     
af51_M=as.md3(af51_S);gc()
af51=copy(af51_M)
