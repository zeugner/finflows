...
library(data.table)
library(openxlsx)  # or readxl
library(MD3)

# 1. Import the Excel file
ecb_file_path <- "data/static/ecb_capital.xlsx"
...
# Save results
saveRDS(ecb_capital_md3, "data/ecb_capital_md3.rds")
write.csv(result_dt, "data/ecb_capital_quarterly.csv", row.names = FALSE)
