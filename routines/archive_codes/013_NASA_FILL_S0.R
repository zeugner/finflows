...
la_l = readRDS("data/domestic_loading_data_files/nasa_unconsolidated_stocks_LIAB.rds")
lat_l = readRDS("data/domestic_loading_data_files/nasa_unconsolidated_flows_LIAB.rds")
...
saveRDS(aall, 'data/intermediate_domestic_data_files/aall_NASA_S0.rds')
saveRDS(la_q, 'data/intermediate_domestic_data_files/la_q.rds')
saveRDS(lat_q, 'data/intermediate_domestic_data_files/lat_q.rds')
saveRDS(lal_q, 'data/intermediate_domestic_data_files/lal_q.rds')
saveRDS(latl_q, 'data/intermediate_domestic_data_files/latl_q.rds')
